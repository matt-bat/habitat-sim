...
| INST-010 | Publish Habitat Sim as a public repository | User request, 2026-07-17 | in_progress | high | model | 2026-07-17T15:41:18Z | `package.json`, `.github/`, `docs/governance/HABITAT-PUBLIC-001.governance.*` | Publication follows the full production release gate. |
...
| INST-012 | Iterate until production ready | User request, 2026-07-17 | in_progress | high | model | 2026-07-17T15:41:18Z | `tests/`, `.github/workflows/ci.yml`, `docs/validation.md` | Full clean-install and recovery gates remain before publication. |
